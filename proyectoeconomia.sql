...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 08-11-2023 a las 02:16:50
...
CREATE TABLE `admin` (
  ...
  `intituciones_admin` int(11) NOT NULL
...
ALTER TABLE `admin`
  ADD PRIMARY KEY (`id`),
  ADD KEY `intituciones_admin` (`intituciones_admin`);
...
--
ALTER TABLE `admin`
  ADD CONSTRAINT `admin_ibfk_1` FOREIGN KEY (`intituciones_admin`) REFERENCES `instituciones` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
